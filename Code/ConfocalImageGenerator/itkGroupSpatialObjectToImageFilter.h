/*=========================================================================
  ...
  Module:    itkGroupSpatialObjectToImageFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkGroupSpatialObjectToImageFilter_h
#define __itkGroupSpatialObjectToImageFilter_h
...
/** \class GroupSpatialObjectToImageFilter
...
class ITK_EXPORT GroupSpatialObjectToImageFilter : public ImageSource<TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef GroupSpatialObjectToImageFilter                     Self;
  ...
  itkTypeMacro(GroupSpatialObjectToImageFilter, ImageSource);
  ...
  typedef typename TInputSpatialObject::BoundingBoxType  BoundingBoxType;
  typedef typename ChildrenListType::iterator ListIteratorType;
...
private:
  ...
  GroupSpatialObjectToImageFilter(const Self&); //purposely not implemented
...
#include "itkGroupSpatialObjectToImageFilter.txx"
#endif
